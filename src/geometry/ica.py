...
for sentence_structure in sentence_structures:
    ...
    for prompt_type in prompt_types:
        ...
        for i_layer in num_layers:
            ...
            reduced_vectors_ica = ica.fit_transform(all_concept_vectors)

            concept_data = {
                "Name": concept_names,
                "ICA1": reduced_vectors_ica[:, 0],
                "ICA2": reduced_vectors_ica[:, 1],
            }
            ...
            # fig.show()
            save_path = f"/home/itai/research/PersonalValuesGeometry/figures/geometry/ICA/{sentence_structure}/{prompt_type}/layer_{i_layer}.png"
